...
const SideDrawer = class {
  ...
  render() {
    ...
    if (this.showContactInfo) {
      mainContent = (index.h("div", { id: "contact-information" }, index.h("h2", null, "Contact information"), index.h("p", null, "Please contact us at:"), index.h("ul", null, index.h("li", null, "Phone: 555-123-4567"), index.h("li", null, "Email: ", index.h("a", { href: "mailto:contact@email.com" }, "contact@email.com")))));
    }
    // You can return () or []
    return [
      index.h("div", { id: "backdrop", onClick: this.onCloseDrawer.bind(this) }),
      index.h("aside", null, index.h("header", null, index.h("h1", null, this.headerTitle), index.h("button", { onClick: this.onCloseDrawer.bind(this) }, "X")), index.h("section", { class: "tabs" }, index.h("button", { class: !this.showContactInfo ? 'active' : '', onClick: this.onContentChange.bind(this, 'navigation') }, "Navigation"), index.h("button", { class: this.showContactInfo ? 'active' : '', onClick: this.onContentChange.bind(this, 'contact') }, "Contact")), index.h("main", null, mainContent))
    ];
  }
};
SideDrawer.style = sideDrawerCss;

exports.jd_side_drawer = SideDrawer;

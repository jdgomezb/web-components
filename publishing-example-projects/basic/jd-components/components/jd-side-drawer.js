...
const SideDrawer = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["jd-side-drawer"];
...
const JdSideDrawer = SideDrawer;
const defineCustomElement = defineCustomElement$1;

export { JdSideDrawer, defineCustomElement };
